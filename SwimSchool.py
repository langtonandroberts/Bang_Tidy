...
# this code is linked to 2 text files users and appointments.
# also has 2 other modules linked to it Calendar.py and CalendarView.py
...
#Define Image
swimimage=Image.open("network.png")
...
#wellcome and name(popup screen).
tk.Label(userFrame,textvariable = loggedInLabel,font=("Courier", 44),bg='lightblue',fg="green").grid(row=1,column=1,columnspan=5)
...
#Time Selector
timeSelectFrame = tk.Frame(bookAppointment,borderwidth=1,bg="blue")#lightblue
